...
// type IncommingCall struct {
// 	Type         string             `json:"type"`
// 	PeerSocketId string             `json:"peerSocketId"`
// 	Offer        SessionDescription `json:"sessionDescription"`
// }
...
// 			// If room already has members → broadcast "joined"
// 			if len(roomToUsers[joinMsg.Room]) >= 1 {
...
// 				for _, c := range roomToUsers[joinMsg.Room] {
...
// 		case "call":
// 			var call IncommingCall
// 			if err := json.Unmarshal(msg, &call); err != nil {
// 				log.Println("Call unmarshal error:", err)
// 				continue
// 			}

// 			fmt.Printf("📞 Incoming call from %s to %s\n", connToID[conn], call.PeerSocketId)
// 			var targetConn *websocket.Conn
// 			for c, id := range connToID {
// 				if id == call.PeerSocketId {
// 					targetConn = c
// 					break
// 				}
// 			}

// 			response := IncommingCall{
// 				Type:         "incomingCall",
